    ...
    <div className='w-full flex gap-5 h-screen bg-zinc-900 p-20 font-["Founders_Grotesk_X-Condensed"] '>
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-8xl leading-none uppercase font-semibold -mb-10 tracking-tighter">
            Eye-
          </h1>
          <h1 className="text-8xl leading-none mt-3 uppercase font-semibold  -mb-10 tracking-tighter">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        ...
        <div className='details mt-20 font-["Neue_Montreal"]'>
          <h1 className="font-light text-xl mt-6 ">S:</h1>
          <a className="block text-xl font-light underline mt-1" href="">
            FaceBook
          </a>
          <a className="block text-xl font-light underline mt-1" href="">
            Instagram
        ...
        <div className='address mt-20 font-["Neue_Montreal"] w-1/3'>
          <div>
           
            <h1 className="font-light text-xl mt-6 ">L:</h1>
            <a className="block text-xl font-light underline mt-1" href="">
              5 W202-196 4th Ave Vancouver, Canada
            </a>
            <a className="block text-xl font-light underline mt-2" href="">
              30 Chukarina St Lviv, Ukraine
            </a>
          </div>
        </div>
        <div className="flex gap-5 mt-16 mr-5 text-zinc-400" >
        <div className="copyright"  >© ochi design 2024. Legal Terms</div>
        <div> Website Clone By Nilesh Rajput </div>
        </div>
